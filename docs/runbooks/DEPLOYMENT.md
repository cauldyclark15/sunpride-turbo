...
9. Run Inventory → **Provision inventory foundation**. Import approved opening quantities through `inventory.setup.postOpeningBalances`; never synthesize stock from an SAP snapshot.
